                ...
                <form method="post" action="{{ route('admin.owners.store')}}">
                  ...
                  <div class="-m-2">
                    ...
                    <div class="p-2 w-full flex justify-around mt-4">
                      <button type="button" location.href='{{ route('admin.owners.index')}}'" class="bg-gray-200 border-0 py-2 px-8 focus:outline-none hover:bg-gray-400 rounded text-lg">戻る</button>
